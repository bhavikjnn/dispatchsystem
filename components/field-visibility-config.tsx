...
export default function FieldVisibilityConfig() {
  ...
  return (
    <Card className="p-8 bg-card border border-border">
      <div className="mb-8">
        <h2 className="text-lg font-semibold text-foreground mb-2">Configure Field Visibility</h2>
        <p className="text-muted-foreground text-sm">
          Currently showing <span className="font-semibold text-primary">{visibleCount}</span> of{" "}
          <span className="font-semibold text-primary">{Object.keys(FIELD_LABELS).length}</span> fields to employees
        </p>
      </div>
      ...
      <div className="flex gap-3 mb-8 flex-wrap">
        <Button onClick={handleSelectAll} className="button-secondary flex items-center gap-2 text-sm">
        ...
        <Button onClick={handleDeselectAll} className="button-secondary flex items-center gap-2 text-sm">
      ...
      <Button onClick={handleSave} disabled={saving} className="button-primary flex items-center gap-2">
        {saving ? (
          <>
