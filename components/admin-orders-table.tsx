...
export default function AdminOrdersTable({ filters, refreshKey }: AdminOrdersTableProps) {
      ...
      <div className="p-6 border-b border-border bg-secondary/5">
        <div className="flex justify-between items-start md:items-center flex-col md:flex-row gap-2">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">Admin view: All {columns.length} fields visible</p>
          </div>
