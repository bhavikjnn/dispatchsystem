        ...
        {activeTab === "form" && (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">Enter order details to submit a new dispatch</p>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-start md:items-center flex-col md:flex-row gap-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">View and download your submitted orders</p>
              </div>
              <DownloadButton downloadType="employee" label="Download Orders" />
            </div>
