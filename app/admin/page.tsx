...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<"orders" | "visibility" | "logs">("orders")
    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-between items-start md:items-center flex-col md:flex-row gap-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">View and manage dispatch orders from all employees</p>
              </div>
              <DownloadButton filters={filters} downloadType="full" label="Download Orders" />
            </div>
            <AdminOrdersTable filters={filters} refreshKey={refreshKey} />
          </div>
        )}
        ...
        {activeTab === "visibility" && (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-foreground">Field Visibility Settings</h2>
              <p className="text-sm text-muted-foreground mt-1">
                Configure which fields employees can see and download
              </p>
            </div>
        ...
        {activeTab === "logs" && (
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-foreground">Download Audit Log</h2>
              <p className="text-sm text-muted-foreground mt-1">Track all data downloads and exports for compliance</p>
            </div>
            <AuditLogsTable />
          </div>
        )}
